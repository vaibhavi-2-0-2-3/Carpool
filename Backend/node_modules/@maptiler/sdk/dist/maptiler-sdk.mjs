...
const $a = "@maptiler/sdk", Ra = "2.5.0", Na = "The Javascript & TypeScript map SDK tailored for MapTiler Cloud", Fa = "dist/maptiler-sdk.mjs", Oa = "dist/maptiler-sdk.d.ts", Da = "dist/maptiler-sdk.css", ja = "module", qa = {
  ".": {
